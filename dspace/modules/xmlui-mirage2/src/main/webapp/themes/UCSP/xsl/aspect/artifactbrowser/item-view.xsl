        ...
        <div class="item-summary-view-metadata">
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <xsl:if test="(count(/mets:METS/mets:fileSec/mets:fileGrp[@USE='CONTENT']/mets:file/mets:FLocat[contains(@xlink:href,'Allowed=y')]/@xlink:href) &gt; 0) and (/mets:METS/mets:dmdSec/mets:mdWrap/mets:xmlData/dim:dim/dim:field[@element='type' and not(@qualifier)])='Imagen'">
                        <div class="visor-imagenes">
                           <div class="foto-content">               
                              <xsl:call-template name="visor-file-images-Openseadragon" />
                          </div>
                        </div>
                    </xsl:if>
...
<xsl:template name="visor-file-images-Openseadragon" >
<div class="simple-item-view-uri item-page-field-wrapper table visorImatges">
 <style>
        .openseadragon1 {
        width: 100%;
        height: 480px;
    ...
    <script type="text/javascript" src='/static/visores/openseadragon/openseadragon.min.js'>&#160;</script>   
    <div id="toolbarDiv" class="toolbar" style="z-index: 10000;"><span style="visibilitty:hidden;display:none">&#160;</span></div>
    <div id="contentDiv" class="openseadragon1"><span style="visibilitty:hidden;display:none">&#160;</span></div>  
    <script type="text/javascript">
        var viewer =     OpenSeadragon({
        id:  "contentDiv",
        prefixUrl:     "/static/visores/openseadragon/images/",
        springStiffness:        10,
        sequenceMode:           true,
        ...
        <xsl:for-each select="/mets:METS/mets:fileSec/mets:fileGrp[@USE='CONTENT']/mets:file">
            {
            type: 'image',
            url:  '<xsl:value-of select="./mets:FLocat/@xlink:href" />',  
            },
        </xsl:for-each>
        ]
        ,
...
<xsl:template name="escapeQuotes">
    ...
    <xsl:choose>
        ...
        <xsl:when test="contains($txt, $singleQuote)">
            <xsl:value-of select="concat(substring-before($txt, $singleQuote), $backSlashQuote)"/>
