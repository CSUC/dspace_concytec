...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
  ...
  <xsl:call-template name="buildFooter"/>
    ...
    <xsl:template name="buildHead">
	    ...
	    <link rel="stylesheet" href="{concat($theme-path, 'lib/css/font-awesome.css')}"/>
    ...
    <xsl:template name="buildHeader">
        ...
        <header>
            <div id="top-bar"><div class="container"><div class="cs-top-right"><div class="cs-top-module cs-module-link"><a href="http://ucsp.edu.pe/asciende/"><i class="cs-in fa fa-external-link-square"></i>Asciende UCSP</a></div><div class="cs-top-module cs-module-link"><a href="http://academico.ucsp.edu.pe" target="_blank"><i class="cs-in fa fa-external-link"></i>Portal Académico</a></div><div class="cs-top-module cs-module-link"><a href="http://gmail.ucsp.edu.pe" target="_blank"><i class="cs-in fa fa-envelope-o"></i>San Pablo Mail</a></div><div class="cs-top-module cs-module-link"><a href="http://ucsp.edu.pe/contacto/" target="_blank"><i class="cs-in fa fa-info-circle"></i>Contacto</a></div><div class="cs-top-module cs-module-social"><a href="https://facebook.com/ucatolicasanpablo" target="_blank" class="cs-in fa fa-facebook"></a></div><div class="cs-top-module cs-module-social"><a href="https://twitter.com/ucsp" target="_blank" class="cs-in fa fa-twitter"></a></div><div class="cs-top-module cs-module-social"><a href="https://plus.google.com/+universidadcatolicasanpablo/videos" target="_blank" class="cs-in fa fa-google-plus"></a></div></div></div></div>
	...
	<a class="" href="http://ucsp.edu.pe/" ><img alt="Universidad Católica San Pablo" src="/themes/UCSP/images/logo_ucsp.png" class="cs-logo" style="width: 417px;"/></a>
	</div>
    ...
    <footer id="colophon" class="site-footer" role="contentinfo"><div class="container"><div class="row"><div class="col-md-3"><div class="route_widget widget_text"><div class="widget-title"><h4>Pregrado</h4></div>          <div class="textwidget"><ul>
    ...
    <div class="clear"></div></div></div><div class="col-md-3"><div class="route_widget widget_text"><div class="widget-title"><h4>Extensión Universitaria</h4></div>           <div class="textwidget"><ul>
    ...
    <div class="clear"></div></div></div><div class="col-md-3"><div class="route_widget widget_text"><div class="widget-title"><h4>Investigación</h4></div>         <div class="textwidget"><ul>
    ...
    <div class="clear"></div></div></div><div class="col-md-3"><div class="route_widget widget_text"><div class="widget-title"><h4>Accesos principales</h4></div>           <div class="textwidget"><ul>
    ...
    <div id="copyright"><div class="container"><div class="row"><div class="col-md-12"><div class="pull-left" style="color:#fff;">Todos los Derechos Reservados 2018 © · <a href="http://ucsp.edu.pe/" style="color:#fff;">Universidad Católica San Pablo</a> | <a href="http://ucsp.edu.pe/terminosycondiciones/" style="color:#fff;">Términos y Condiciones</a> | <a href="http://ucsp.edu.pe/politica-de-privacidad/" style="color:#fff;">Política de Privacidad</a></div>
<div class="pull-left" style="color:#fff;">Campus San Lázaro - Quinta Vivanco s/n, Urb. Campiña Paisajista, Arequipa    |    Telf: +51 54 605630, +51 54 605600  anexo 200, 300 ó 390 | Escríbenos a: <a href="mailto:institucional@ucsp.edu.pe" style="color:#fff;">institucional@ucsp.edu.pe</a></div></div></div></div></div>
    </xsl:template>
